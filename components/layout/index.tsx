    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <aside className="mt-16 w-64 bg-white p-4 shadow-lg">
        <ul>
          ...
          <li>
            <Link href="/payments" className="block my-2 py-2 px-4 rounded hover:bg-blue-500 hover:text-white transition-colors duration-200">
              Payments
            </Link>
          </li>
          <li>
            <Link href="/balance" className="block my-2 py-2 px-4 rounded hover:bg-blue-500 hover:text-white transition-colors duration-200">
              Balance
            </Link>
          </li>
        </ul>
